...
export default function MovieDetails() {
    ...
    async function getMovieDetails() {
        let {data} = await axios.get(`https://api.themoviedb.org/3/movie/${id}?api_key=77cbb62c38149cca587a604894cb9193&language=en-US`)
        setobjDetails(data)
    }
        ...
        <div className="row">
            ...
            <div className="col-md-8">
                <div className="moviedetails">
                    ...
                    <h6 className='mt-2'>Spokenlanguage : <small className='ms-3'>{objDetails.spoken_languages[0].english_name} </small> </h6> 

...
export default function Populartv3() {
    ...
    async function getTrendingTv() {
      let {data} = await axios.get('https://api.themoviedb.org/3/tv/popular?api_key=77cbb62c38149cca587a604894cb9193&language=en-US&page=3')
  ...
  return <>
    ...
    <div className=' p-3 justify-content-center  d-flex '>
        <div className='justify-content-center  d-flex pagi border border-1 '>
            ...
            <Link className="nav-link item px-2 active mx-3 my-2" aria-current="page" to="/Popular2">2</Link>
            <Link className="nav-link text-warning px-2 active mx-3 my-2" aria-current="page" to="/Popular3">3</Link>
        </div>
    </div>

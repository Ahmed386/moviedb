...
export default function Toptvs() {
    ...
    async function Toptvs() {
      let {data} = await axios.get('https://api.themoviedb.org/3/tv/top_rated?api_key=77cbb62c38149cca587a604894cb9193&language=en-US&page=1')
  ...
  return <>
    ...
    <div className=' p-3 justify-content-center  d-flex '>
        <div className='justify-content-center  d-flex pagi border border-1 '>
            <Link  id='p1' className="nav-link text-warning px-2 active mx-3 my-2" aria-current="page" to="/Toptvs">1</Link>
            <Link className="nav-link item px-2 active mx-3 my-2" aria-current="page" to="/Toptvs2">2</Link>
            <Link className="nav-link item px-2 active mx-3 my-2" aria-current="page" to="/Toptvs3">3</Link>
        </div>
    </div>

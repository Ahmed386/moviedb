...
export default function Toptvs2() {
    ...
    async function getTrendingTv() {
      let {data} = await axios.get('https://api.themoviedb.org/3/tv/top_rated?api_key=77cbb62c38149cca587a604894cb9193&language=en-US&page=2')
  ...
  return <>
    ...
    <div className=' p-3 justify-content-center  d-flex '>
        <div className='justify-content-center  d-flex pagi border border-1 '>
            ...
            <Link className="nav-link text-warning px-2 active mx-3 my-2" aria-current="page" to="/Toptvs2">2</Link>
